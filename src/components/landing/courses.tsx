          ...
          <div className="relative">
            ...
            <dl className="mt-10 space-y-10">
              ...
              <div className="flex w-full items-center">
                <a href="#sign-up">
                  <button className="gap-1justify-center group inline-flex items-center rounded-md bg-[#EF3054] px-8 py-2 text-sm font-medium text-white shadow backdrop-blur-sm transition-all hover:scale-105 hover:text-opacity-100 active:scale-100 sm:text-xl">
                    Signup Now <IoArrowForward />
                  </button>
                </a>
                <Link href="/courses/react-and-beyond">
                  <button className="group inline-flex items-center justify-center gap-1 rounded-md px-8 py-2 text-sm font-medium text-[#EF3054] underline underline-offset-4 transition-all hover:scale-105 hover:text-opacity-100 active:scale-100 sm:text-2xl">
                    Learn More
                  </button>
                </Link>
              </div>
