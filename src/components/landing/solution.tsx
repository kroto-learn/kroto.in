...
const Stats: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex min-h-screen max-w-7xl flex-col items-start justify-center px-10 py-24 text-center text-5xl font-thin sm:text-left md:py-28 md:text-5xl lg:py-36 lg:text-8xl">
        <div className="flex flex-col gap-10">
          ...
          >
            <h1>
              It&apos;s about{" "}
              <span className="font-semibold uppercase">You </span>
